...
public class EspecificarEquipaController {
    ...
    public Equipa especificarEquipa(String codigoEquipa, Acronimo acr, String designacao, Set<Colaborador> colab, TipoEquipa tipoEquipa){

        try {
            return repoEquipa.save(new Equipa(new CodigoEquipa(codigoEquipa), acr, designacao, colab, tipoEquipa));
